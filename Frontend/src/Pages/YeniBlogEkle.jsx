    ...
    <section className="blog-section">
      ...
      <form className="blog-form" onSubmit={handleFormSubmit}>
        ...
        <div className="Image-Yukle">
          <label className="Panel-Blog-Yukle-Label" htmlFor="Image">
            Resim Yükle
          </label>
          <input
            className="Panel-Blog-Yukle"
            type="file"
            id="thumbnail"
            accept="image/*"
            onChange={(e) => setThumbnail(e.target.files[0])}
            disabled={wait && "disable"}
          />
        </div>

        <div className="Image-Yukle">
          <label className="Panel-Blog-Yukle-Label" htmlFor="images">
            Resimler Yükle
          </label>
          <input
            className="Panel-Blog-Yukle"
        ...
        <div className="Panel-Blog-Yukle-Div">
          <label className="Panel-Blog-Yukle-Label" htmlFor="title">
            Başlık
          </label>
          <input
            className="Panel-Blog-Yukle"
          ...
          <label className="Panel-Blog-Yukle-Label" htmlFor="subTitle">
            İçerik
          </label>
          <input
            className="Panel-Blog-Yukle"
        ...
        <div>
          ...
          <label className="Panel-Blog-Yukle-Label" htmlFor="contentSubTitle">
            İçerik
          </label>
          <input
            className="Panel-Blog-Yukle"
        ...
        <div>
          <label className="Panel-Blog-Yukle-Label" htmlFor="subTitle1">
            Alt Başlık 1
          </label>
          <input
            className="Panel-Blog-Yukle"
          ...
          <label className="Panel-Blog-Yukle-Label" htmlFor="contentSubTitle1">
            İçerik
          </label>
          <input
            className="Panel-Blog-Yukle"
        ...
        <div>
          <label className="Panel-Blog-Yukle-Label" htmlFor="subTitle2">
            Alt Başlık 2
          </label>
          <input
            className="Panel-Blog-Yukle"
          ...
          <label className="Panel-Blog-Yukle-Label" htmlFor="contentSubTitle2">
            İçerik
          </label>
          <input
            className="Panel-Blog-Yukle"
        ...
        <div>
          <label className="Panel-Blog-Yukle-Label" htmlFor="subTitle3">
            Alt Başlık 3
          </label>
          <input
            className="Panel-Blog-Yukle"
          ...
          <label className="Panel-Blog-Yukle-Label" htmlFor="contentSubTitle3">
            İçerik
          </label>
          <input
            className="Panel-Blog-Yukle"
        ...
        <div>
          <label className="Panel-Blog-Yukle-Label" htmlFor="subTitle4">
            Alt Başlık 4
          </label>
          <input
            className="Panel-Blog-Yukle"
          ...
          <label className="Panel-Blog-Yukle-Label" htmlFor="contentSubTitle4">
            İçerik
          </label>
          <input
            className="Panel-Blog-Yukle"
